          ...
          <div class="lg:col-span-6 fade-up [animation-delay:120ms] min-w-0 w-full">
            <div class="relative">
              ...
              <div class="relative rounded-2xl bg-white ring-1 ring-slate-200 shadow-soft overflow-hidden">
                <div class="flex items-center gap-1.5 px-3 sm:px-4 py-2 sm:py-3 border-b border-slate-100 bg-slate-50 min-w-0">
                  ...
                  <span
                    class="hidden sm:inline-block ml-3 text-[11px] text-slate-500 font-mono truncate min-w-0 flex-1 leading-none"
