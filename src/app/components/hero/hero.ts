...
@Component({
  ...
  template: `
    <section id="top" class="relative overflow-hidden pt-28 lg:pt-36 pb-20 lg:pb-28 hero-radial">
      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div class="lg:col-span-6 fade-up">
            ...
            <h1 class="mt-5 font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.05] text-slate-900">
            ...
            <div class="mt-8 flex flex-wrap items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-soft hover:bg-slate-800 transition-colors"
              >
                Try the live demo
              ...
              <a
                href="#showcase"
                class="inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-slate-800 ring-1 ring-slate-200 hover:bg-slate-50 transition-colors"
              >
          ...
          <div class="lg:col-span-6 fade-up [animation-delay:120ms]">
            <div class="relative">
              ...
              <div class="relative rounded-2xl bg-white ring-1 ring-slate-200 shadow-soft overflow-hidden">
                ...
                <div class="p-5 grid gap-4">
                  ...
                  <div class="grid grid-cols-3 gap-3">
                    <div class="rounded-xl bg-gradient-to-br from-brand-500 to-brand-700 text-white p-4">
                      <div class="text-[11px] uppercase tracking-wide opacity-80">Now serving</div>
                      <div class="mt-1 text-3xl font-extrabold leading-none">#07</div>
                      <div class="mt-2 text-[11px] opacity-80">Avg wait • 4m 12s</div>
                    </div>
                    <div class="rounded-xl bg-slate-50 ring-1 ring-slate-200 p-4">
                      <div class="text-[11px] uppercase tracking-wide text-slate-500">In queue</div>
                      <div class="mt-1 text-3xl font-extrabold leading-none text-slate-900">14</div>
                      <div class="mt-2 text-[11px] text-slate-500">Next up: Aisha K.</div>
                    </div>
                    <div class="rounded-xl bg-slate-50 ring-1 ring-slate-200 p-4">
                      <div class="text-[11px] uppercase tracking-wide text-slate-500">Today's revenue</div>
                      <div class="mt-1 text-3xl font-extrabold leading-none text-slate-900">$1,284</div>
                      <div class="mt-2 text-[11px] text-emerald-600 font-semibold">+18% vs avg</div>
                    </div>
                  </div>
                  ...
                  <div class="rounded-xl bg-slate-900 text-white p-4">
                    <div class="flex items-center justify-between">
                      <div class="text-[11px] uppercase tracking-wide opacity-70">Live queue</div>
                      <div class="text-[11px] opacity-70">Morning shift • Dr. Hasan</div>
                    </div>
                    <div class="mt-3 flex items-center gap-2 overflow-hidden">
                      @for (t of tokens; track t) {
                        <span
                          class="grid place-items-center h-9 w-9 shrink-0 rounded-lg text-sm font-bold"
              ...
              <!-- Floating chip -->
              <div class="hidden sm:flex absolute -left-6 bottom-10 items-center gap-2 rounded-2xl bg-white px-4 py-3 ring-1 ring-slate-200 shadow-soft">
                <span class="grid h-9 w-9 place-items-center rounded-xl bg-emerald-100 text-emerald-700"><app-icon name="invoice" [size]="18" /></span>
                <div>
                  <div class="text-xs text-slate-500">Shift closed</div>
                  <div class="text-sm font-semibold text-slate-900">Invoice #2104 finalized</div>
                </div>
              </div>

              <div class="hidden sm:flex absolute -right-4 -top-4 items-center gap-2 rounded-2xl bg-white px-4 py-3 ring-1 ring-slate-200 shadow-soft">
                <span class="grid h-9 w-9 place-items-center rounded-xl bg-sky-100 text-sky-700"><app-icon name="tv" [size]="18" /></span>
                <div>
                  <div class="text-xs text-slate-500">Waiting room TV</div>
                  <div class="text-sm font-semibold text-slate-900">Now serving #07</div>
                </div>
              </div>
            </div>
          </div>
